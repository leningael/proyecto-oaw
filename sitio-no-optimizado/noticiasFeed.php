                        ...
                        <div class="row">
                            <div class="col">
                                <div class="d-flex flex-wrap mb-2">
                                    <a id="refreshNews" class="btn btn-primary my-1 me-2" href="scripts/actualizarNoticias.php">
                                        <img class="align-text-top me-1" src="assets/icons/refresh.svg" alt="Recientes">Actualizar
                                    </a>
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle my-1 me-2" type="button" id="dropdownOrden" data-bs-toggle="dropdown" aria-expanded="false">
                                            <img class="align-text-top me-1" src="assets/icons/sliders.svg" alt="Recientes">Ordenar por
                                        </button>
