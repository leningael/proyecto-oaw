<?php
    ...
    function guardarNoticias($id_feed, $feed){
        ...
        foreach($feed->get_items() as $item){
            ...
            $sentenciaSQL = $conexion->prepare("INSERT INTO noticias (id_feed, titulo, autor, fecha, descripcion, contenido, imagen) 
                                                            VALUES (:idFeed,:titulo,:autor,:fecha,:descripcion,:contenido,:imagen);");
